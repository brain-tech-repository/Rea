                ...
                <div className={`flex-1 overflow-y-auto mt-6 mb-4 px-2 space-y-4 ${isInputFocused || hideGreeting ? 'block' : 'hidden'}`}>
                    ...
                    {isLoading && (
                        <div className="max-w-[75%] flex gap-2 self-start">
                            <div className="w-6 h-6 mt-1 rounded-full overflow-hidden">
                                <img src="/rea.png" alt="Bot thinking" className="w-full h-full object-cover" />
                            </div>
                    ...
                    <div className="p-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {[
                                ...
                                <div
                                    key={index}
                                    className="rounded-lg p-4 shadow hover:shadow-md cursor-pointer flex flex-col items-center gap-2 bg-gray-100"
                                >
