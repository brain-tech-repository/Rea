          ...
          h-min-screen  w-full rounded-[12px] border border-[#E2E4E9] bg-white overflow-hidden"
            ...
            rounded-full border-[0.864px] border-white bg-[#E2E4E9] backdrop-blur-[4.32px] overflow-hidden"
              ...
              <div>
                ...
                <div className="flex items-center self-stretch my-5">
                    <div className="w-[220px] h-px bg-gradient-to-r from-transparent to-[#E2E4E9]"></div>
                ...
                <div className="flex flex-col items-start gap-3 p-3 px-5 flex-1 self-stretch rounded-[12px] bg-[#F6F8FA]">
                    ...
                    <p className="text-center text-[14px] leading-[20px] tracking-[-0.084px] font-normal text-[color:var(--text-soft-400,#868C98)] font-['Inter']">
