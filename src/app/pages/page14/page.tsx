...
export default function Page14() {
  ...
  return (
    <div
      className={
        isSamplesVisible
          ? "relative flex flex-col w-full px-4 py-6 bg-white min-h-screen"
          : "relative flex flex-col w-full px-4 py-6 bg-white h-full"
      }
    >
      {/* Header */}
      <div className="mb-4">
      ...
      >
        {!hideGreeting && (
          <div
            className={`transition-all duration-300 ${isInputFocused ? "mb-4" : ""
              }`}
          >
        ...
        >
          <div
            className={
              "relative w-full mt-4 flex items-end gap-2 border border-gray-300 rounded-2xl px-4 py-4 bg-white"
            }
          >
                ...
                <>
                  ...
                  <button
                    onClick={() => {
                      ...
                      // Explicitly type the object as Message
                      const voiceMessage: Message = {
                        text: `▶  ━━━━━━   ${recordTime}s`,
                        type: "outgoing",
                      };
