...
import Page13 from "../page13/page";
...
export default function ChatBox() {
  ...
  return (
   <div className={showSamples ?"relative flex flex-col w-full px-4 py-6 bg-white min-h-screen":"relative flex flex-col w-full px-4 py-6 bg-white h-full"}>
      {/* Header */}
      <div className="mb-4">
